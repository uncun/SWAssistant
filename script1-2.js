    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager) {
                ...
                this.addToCSS(`button#changeProfileNext { position: absolute; top: 275px; right: 16px; ; border: 2px solid #973804; border-radius: 5px; width: 52px; }`);
                ...
                this.addToCSS(`button#changeProfilePrev { position: absolute; top: 205px; right: 16px; border: 2px solid #973804; border-radius: 5px; width: 52px; }`);
