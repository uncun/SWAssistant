    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager) {
                ...
                this.addToCSS(`button#changeProfileNext { position: absolute; top: 125px; left: 139px; ; border: none;  }`);
                ...
                // }`);
                this.addToCSS(`button#changeProfilePrev { position: absolute; top: 100px; left: 139px; border: none;  }`);
