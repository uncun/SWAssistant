    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager) {
                ...
                this.addToCSS(`button#changeProfileNext { position: absolute; top: 175px; right: 16px; background: linear-gradient(0deg, rgba(252,238,54,1) 0%, rgba(247,121,12,1) 100%); border: 2px solid #973804; border-radius: 5px; width: 52px; }`);
                ...
                this.addToCSS(`button#changeProfilePrev { position: absolute; top: 175px; right: 75px; background: linear-gradient(0deg, rgba(252,238,54,1) 0%, rgba(247,121,12,1) 100%); border: 2px solid #973804; border-radius: 5px; width: 52px; }`);
