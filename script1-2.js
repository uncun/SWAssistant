    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager) {
                ...
                this.addToCSS(`button#changeProfileNext {  border: 2px solid #973804; border-radius: 5px; width: 52px; }`);
                ...
                this.addToCSS(`button#changeProfilePrev {  border: 2px solid #973804; border-radius: 5px; width: 52px; }`);
